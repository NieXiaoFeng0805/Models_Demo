...
class Decoder(nn.Module):
    def __init__(self, dims, dim, class_num=2):
        ...
        #                                norm_cfg=dict(type='BN', requires_grad=True))
        self.linear_fuse = BasicConv(embedding_dim * 4, embedding_dim, kernel_size=1)
...
class SSFormer(nn.Module):
    ...
    def init_weights(self):
        # 加载预训练权重
        pretrain_path = "./PreWeights/ssformer_S.pth"
